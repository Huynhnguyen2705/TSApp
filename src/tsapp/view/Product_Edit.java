 ...
 * @author Huynh
 */
public class Product_Edit extends javax.swing.JPanel {
    ...
    private final String SUA = ">Sửa";
    private Product_controller controller;
    private String selectedID;
    

    public Product_Edit(Employee emp) {
        initComponents();
        this.emp = emp;
    ...
    private void createUI() {
        ...
        selectedID = ProductSearch_view.selectedID;
        Product prod = controller.searchProductID(selectedID);
        CusIDLabel.setText(selectedID);
        try {
            typeCbx.setModel(new DefaultComboBoxModel(controller.getTypes()));
        } catch (ClassNotFoundException | SQLException ex) {
            Logger.getLogger(Product_Edit.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void loadDataToTF(Product selectedProd){
        NameTF.setText(selectedProd.getProdName());
        priceTF.setText(selectedProd.getPrice().toString());
        typeCbx.setSelectedItem(selectedProd.getTypeName());
        sizeCbx.setSelectedItem(selectedProd.getSizeName());
        if(selectedProd.getStatus() == 1){
            statusCkbox.setSelected(false);
        }else{
            statusCkbox.setSelected(true);
        }
    }
    ...
    public final void actionListener() {
        ...
        btnBack.addActionListener((ActionEvent e) -> {
            Main.tabbedPane.setSelectedComponent(ProductSearch_view.searchView);
        ...
        btnEdit.addActionListener((ActionEvent e) -> {
            if (!NameTF.getText().isEmpty() && !priceTF.getText().isEmpty()) {
                if (updateProd()) {
                    ...
                    Main.tabbedPane.add("Tra cứu", new ProductSearch_view(emp));
    ...
    private boolean updateProd() {
        ...
        if (controller.updateProduct(prod)) {
            return true;
        } else {
            return false;
        }
    ...
    private void initComponents() {
        ...
        btnCancel.setBounds(160, 310, 110, 30);
        ...
        jPanel1.add(jLabel4);
        jLabel4.setBounds(60, 220, 40, 15);
    ...
    jPanel1.add(btnEdit);
    btnEdit.setBounds(290, 310, 110, 30);

    jLabel7.setFont(new java.awt.Font("Myriad Pro", 0, 14)); // NOI18N
    jLabel7.setText("Trạng thái:");
    jPanel1.add(jLabel7);
    jLabel7.setBounds(60, 270, 62, 15);

    statusCkbox.setFont(new java.awt.Font("Myriad Pro", 0, 14)); // NOI18N
    statusCkbox.setText("Không kinh doanh");
    jPanel1.add(statusCkbox);
    statusCkbox.setBounds(150, 260, 210, 30);

    add(jPanel1);
    jPanel1.setBounds(410, 200, 520, 370);
