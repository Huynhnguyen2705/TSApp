 ...
 * @author Huynh
 */
public class Employee_view extends javax.swing.JPanel {
    ...
    public Employee_view(Employee emp) {
        initComponents();
        this.emp = emp;
    ...
    public final void actionListener() {
        ...
        btnTraCuu.addActionListener((ActionEvent e) -> {
            ...
            EmployeeSearch_view search_view = new EmployeeSearch_view(emp);
        ...
        btnThem.addActionListener((ActionEvent e) -> {
            Main.addTabBottomDown(Main.NHANVIEN, Main.emp_view);
            Employee_Add add = new Employee_Add(emp);
