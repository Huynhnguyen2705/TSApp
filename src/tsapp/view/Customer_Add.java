 ...
 * @author Huynh
 */
public class Customer_Add extends javax.swing.JPanel {
    ...
    public Customer_Add(Employee emp) {
        initComponents();
        this.emp = emp;
    ...
    private void createUI() {
        ...
        listCus = controller.searchCustomer("kh");
        CusIDLabel.setText("KH" + (listCus.get(0).getCusInt() + 1));
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnAdd);
        btnAdd.setBounds(260, 150, 110, 30);
